...
#### EXTERNAL SMA
set_property PACKAGE_PIN N11 [get_ports sma_clkin]
set_property PACKAGE_PIN T13 [get_ports sma_clkout]
create_clock -period 100.000 -name sma_clkin -waveform {0.000 5.000} [get_nets sma_clkin]
#### 


create_clock -period 100.000 -name usb_clk -waveform {0.000 5.000} [get_nets usb_clk]
create_clock -period 100.000 -name tio_clkin -waveform {0.000 5.000} [get_nets tio_clkin]
create_clock -period 100.000 -name pll_clk1 -waveform {0.000 5.000} [get_nets pll_clk1]
